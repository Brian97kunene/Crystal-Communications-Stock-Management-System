...
function ManualRowSelection() {
    ...
    return (
        <div className="Live_Feed">
            ...
            <h2 style={{ padding: "50px", marginTop: "0px", marginLeft: "00px", color: "#0c086b", fontFamily: "Century Schoolbook" }}   >Syntech Live Feed:</h2> <h1 style={{ marginTop: "-103px", marginLeft: "345px", color: "#0c086b", fontWeight: "bold", fontFamily: "Century Schoolbook" }}>[ {liveproducts.length} ]  Products {lastUpdates}  </h1>  
            ...
            {searchTerm && (<><h1 style={{ marginTop: "0px", marginRight: "00px" }}>Syntech Feed Results for: "{searchTerm}"</h1>
